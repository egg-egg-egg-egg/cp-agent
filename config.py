...
_DERIVED = {
    ...
    "CROSS_CHECK_MODEL": lambda cfg: cfg.get("cross_check_model", ""),
    "DIFFICULTY_REVIEW": lambda cfg: cfg.get("difficulty_review", False),
    "DIFFICULTY_REVIEW_MODEL": lambda cfg: cfg.get("difficulty_review_model", ""),
